<div class="form-row">
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" name="last_name" value="{{$profile->Person->last_name }}" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" id="last_name" placeholder="Last Name"required>    
            </div>                               
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" name="first_name" value="{{$profile->Person->first_name }}" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" id="first_name" placeholder="First Name">
        ...
        <div class="col-md-4 mb-3">
          <label for="middle_name" class="control-label">Other Name</label>
          <input type="text" name="middle_name" value="{{$profile->Person->middle_name}}" class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" id="middle_name" placeholder="Other Names">
                ...
                <div class="toggle_container" id="Description">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6  form-group">
                          ...
                          <div class="input-group">
                              ...
                              <input type="text" name="birthday" value="{{$profile->Person->birthday}}" class="form-control{{ $errors->has('birthday') ? ' is-invalid' : '' }}"/>
                          </div>
                      ...
                      <div class="col-md-6 mb-3 form-group">
                          ...
                          <div class="custom-control custom-radio custom-control-inline">
                              <input id="Female" name="gender" type="radio" value="Female" class="custom-control-input">
                    ...
                    <div class="form-row mb-4">
                        <div class="col-md-6 mb-3 form-group">
                            ...
                            <select name="religion" class="custom-select d-block w-100 select2" id="religion">
                        ...
                        <div class="col-md-6 mb-3 form-group">
                            ...
                            <input id="primary_language" type="text" value="{{ $profile->Person->primary_language}}" class="form-control{{ $errors->has('primary_language') ? ' is-invalid' : '' }}" name="primary_language" >
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3 form-group">
                            ...
                            <input id="birthplace" type="text" value="{{ $profile->Person->birthplace}}" class="form-control{{ $errors->has('birthplace') ? ' is-invalid' : '' }}" name="birthplace" >
                        ...
                        <div class="col-md-6  form-group">
                            ...
                            <input type="number" name="birth_sequence" value="{{ $profile->Person->birth_sequence}}" class="form-control{{ $errors->has('birth_sequence') ? ' is-invalid' : '' }}"/>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3 form-group">
                            ...
                            <select name="state_of_origin" class="custom-select d-block w-100 select2 {{ $errors->has('state_id') ? ' is-invalid' : '' }}" id="state">

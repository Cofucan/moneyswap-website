...
<div class="row">
    ...
    {{-- <div class="col-md-3 col-sm-5 mb-3">
        <div class="text-center">
            <img src="{{ asset('icons/avatar.png')}}" class="avatar img-circle img-thumbnail" alt="Upload Candidate Photo">

            <input type="file" name="passport_photo" class="form-control center-block file-upload {{ $errors->has('passport_photo') ? ' is-invalid' : '' }}">
        </div>
    </div> --}}
</div>
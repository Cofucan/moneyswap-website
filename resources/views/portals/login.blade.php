            ...
            <div class="card card1">
                <div class="row justify-content-center my-auto">
                    ...
                    <div class="text-center mb-4">
                        <a href="{{ config('app.url') }}/cpanel" class="create-account btn-white mr-2">Control Panel</a> <a href="{{ config('app.url') }}/webmail" target="_blank" class="sidebar-link btn-white"><span>Check Email</span></a>
                    </div>
                </div>
            </div>
        </div>

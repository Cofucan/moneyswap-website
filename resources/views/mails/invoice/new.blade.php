...
<tr>
    <table>
        ...
        <h2 class="pd-2">Dear {{ $invoice->Profile->Person->full_name }},</h2>
        <p class="pd-2">This is a notice that an invoice has been generated for {{ $invoice->Bill->Client->Person->candidate_name }} on {{$invoice->created_at}}.</h3>
            <br><br>
    </table>

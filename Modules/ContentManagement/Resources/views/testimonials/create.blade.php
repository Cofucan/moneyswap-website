        ...
        <div class="container" data-aos="fade-up">
          <div class="row">
            ...
            @include('partials.alert')
                <div class="form-card">
                  <div clas="card-body">
                    <form method="POST" action="{{ route('testimonials.store') }}" id="CreateTestimonial" class="php-email-form">
                      {{csrf_field()}}
                        @include('contentmanagement::testimonials._form')
                        
                      <div class="p-t-20">
                        <button type="submit" class="btn btn--radius btn--green">Submit Feedback</button>
                      </div>
                    </form>
                  </div>

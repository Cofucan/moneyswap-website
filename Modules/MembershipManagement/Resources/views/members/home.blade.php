      ...
      <div class="container about">
        ...
        <div class="row mt-2">
          <div class="col-md-8 offset-md-2 text-center text-white">
            <h4 class="text-uppercase mb-4">Become a Member Now</h4>
            <h5 class="mb-4">Join other Godly Women of Faith  to touch the lives of others </h5>
            <a href="{{ url('members/join') }}" class="primary-btn">Join us Now</a>
          </div>

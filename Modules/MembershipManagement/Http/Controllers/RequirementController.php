...
use Modules\MembershipManagement\Traits\MemberTrait;
...
class RequirementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('membershipmanagement::requirements.index', compact('page', 'requirements', 'howitworks', 'advantages'));
    }
    ...
    public function pay()
    {
        ...
        $page = Page::where('page_tag', $page_tag)->first();
        return view('membershipmanagement::requirements.pay', compact('page', 'requirements'));
    }
    ...
    {
        //
        return view('membershipmanagement::requirements.create');
    }
    ...
    {
        //
        return view('membershipmanagement::requirements.show',compact('requirement'));
    }
    ...
    public function edit(Requirement $requirement)
    {
        ...
        return view('membershipmanagement::requirements.edit',compact('requirement', 'programs'));
    }

        public function manage()
        {
        $requirements = Requirement::all();
        return view('membershipmanagement::requirements.manage', compact('requirements'));
        }

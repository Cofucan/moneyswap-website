<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control{{ $errors->has('postal_code') ? ' is-invalid' : '' }}" id="postal_code" name="postal_code" placeholder="Enter Postal Code" value="{{old('postal_code') }}"  >
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3 form-group">
            ...
            <select name="state" class="custom-select d-block w-100 select2 {{ $errors->has('state') ? ' is-invalid' : '' }}" id="state" required>
    ...
    <div class="form-group mb-5">
        ...
        <input type="text" name="neighbourhood_name" value="{{old('neighbourhood_name') }}" class="form-control{{ $errors->has('neighbourhood_name') ? ' is-invalid' : '' }}" id="neighbourhood_name" placeholder="Ajah">

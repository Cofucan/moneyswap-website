    ...
    <div class="form-row">
        ...
        <div class="col-md-6 form-group">
            ...
            <input type="text" name="city_code" value="{{old('city_code')}}" class="form-control" placeholder="e.g LG"  id="city_code" />
    ...
    <div class="form-group mb-5">
        ...
        <input type="text" name="city_name" value="{{old('city_name')}}" class="form-control" placeholder="e.g Lagos"  id="city_name" />

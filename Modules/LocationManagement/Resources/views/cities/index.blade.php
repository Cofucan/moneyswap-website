...
<div class="row">
  ...
  <div class="col-md-3">
	  <div class="page_button">
        <a href="{{ url('cities/upload') }}" class="btn btn-sm btn-primary">Import  <i class="fa fa-arrow-down"></i></a>
        <a href="{{ url('cities/export') }}" class="btn btn-sm btn-warning">Export  <i class="fa fa-arrow-down"></i></a>
      </div>
        {{-- modal begins--}}

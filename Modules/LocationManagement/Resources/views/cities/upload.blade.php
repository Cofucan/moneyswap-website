...
@section('page_title', 'Upload Cities')
@push('styles')
...
<div class="container-fluid">
    <div class="bread-crumb bg5 flex-w p-l-5 p-t-5 p-b-5 p-l-15-sm m-b-10">
		...
		<a href="{{ url ('cities')}}" class="s-text16">
			Cities
			<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
		</a>
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Upload Cities </h4>
            <span>Browse to the file location and Click the upload button </span>
            <p>Only xls, xlsx and csv files are supported </p>
            <hr>
          <form method="POST" action="{{ route('cities.import') }}" id="UploadNeighbourhoods" enctype="multipart/form-data">
            {{csrf_field()}}

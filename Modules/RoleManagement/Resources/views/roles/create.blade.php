          ...
          <h4 class="mb-3">Add New Role </h4>
            <form action="{{ url('roles') }}" method="POST"  id="CreateRole" novalidate>
                ...
                <div class="form-group">
                    ...
                    <textarea id="overview" class="form-control" value="{{old ('overview')}}" name="story" style="height: 200px">
                    </textarea>
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select d-block w-100"  name="role_category_id" id="role_category_id" required>

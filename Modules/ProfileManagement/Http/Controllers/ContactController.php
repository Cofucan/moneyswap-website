...
use Modules\ProfileManagement\Entities\Contact;
...
use Modules\ProfileManagement\Entities\ContactType;
...
use ContactTrait;
    ...
    public function create()
    {
        ...
        return view('profilemanagement::contacts.create', compact('contactTypes', 'contactTags'));
    }
    ...
    {
        //
        $contacts = Contact::has('Profile')->get();
        ...
        return view('profilemanagement::contacts.manage' )->withContacts($contacts);
    }
    ...
    {
        //
        return view('profilemanagement::contacts.show',compact('contact'));
    }
    ...
    public function edit(Contact $contact)
    {
        ...
        $contactTags = $this->contactTags;
         return view('profilemanagement::contacts.edit',compact('contact', 'contactableTypes', 'contactTypes', 'contactTags'));
    }

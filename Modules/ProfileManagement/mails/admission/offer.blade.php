@component('mail::message')
 ...
 <tr class="wrapper">
    ...
    <h2 class="pd-2">Dear  {{ $admission->Student->Profile->full_name }},</h2>  
    <p class="pd-2">It is our pleasure to inform you that your child <b>{{ $admission->Student->Person->candidate_name }}</b> was successful at our 2019/ 2020 entrance examination and has been admitted to our college. Kindly login to the <a href="http://www.silvervalleyschools.com/admin">School Portal</a>  to accept the offer</p>     
    <br>
    <p class="pd-2">

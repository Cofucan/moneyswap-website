@component('mail::message')
 ...
 <tr class="wrapper">
    ...
    <p class="pd-2">We are pleased to inform you of <b> {{ $admission->Student->Person->candidate_name }}</b>'s success in our admission exercise, 
            and admitted into  <b>{{ $admission->Grade->label }} ({{$admission->Stream->stream_name}})</b> for the {{$admission->AcademicTerm->AcademicSession->school_year }} session</p>     
    <br>
    <p class="pd-2">

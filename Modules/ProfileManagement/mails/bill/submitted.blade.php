...
<tr>
    <h1 class="welcome-text"> {{$bill->AcademicTerm->academic_term}} Bill Generated</h1>
        <h2 class="pd-2">Dear {{ $bill->Client->Profile->full_name }},</h2> <br>
        <p class="pd-2">A new bill has been generated for {{ $bill->Client->Person->name }}, kindly login to your dashboard to review and accept the bill.</h3>
        <br><br>
        <p class="pd-2">

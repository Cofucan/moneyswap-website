<div class="form-row">
    <div class="col-md-4 mb-3">
        ...
        <div class="input-group">
          ...
          <input type="text" name="last_name" value="{{$person->last_name }}" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" id="last_name" placeholder="Last Name"required>    
        </div>                               
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" name="first_name" value="{{$person->first_name }}" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" id="first_name" placeholder="First Name">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" name="middle_name" value="{{$person->middle_name}}" class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" id="middle_name" placeholder="Other Names">
    ...
    <div class="form-row mb-4">
        ...
        <div class="col-md-6 mb-3 form-group">
            ...
            <input id="primary_language" type="text" value="{{ $person->primary_language}}" class="form-control{{ $errors->has('primary_language') ? ' is-invalid' : '' }}" name="primary_language" >

                ...
                <tbody>
                    ...
                    <tr class="user{{$user->id}}">
                        ...
                        @foreach ($user->Roles as $role)
                            ...
                            <div class="row">
                            <div class="col-md-5">{{ $role->role_name }}</div>
                                ...
                                <div class="modal fade bd-example-modal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabelS" aria-hidden="true">
                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <h5 class="modal-title text-center">Editing {{$user->full_name}} role</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>
                                            <div class="modal-body">
                                            <form method="POST" action="{{ route('people.addrole', $user->id) }}" id="UpdateDesignation" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    @method('PUT')
                        ...
                        @endforeach
                         ...
                         <td>
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a class="btn btn-primary btn-sm" href="{{ route('people.edit',$user->id) }}"><i class="fa fa-pencil"></i></a>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    {{-- modal begins--}}
                                        <div class="modal fade bd-example-modal-lg{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabelS" aria-hidden="true">
                                            <div class="modal-dialog modal-md modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title text-center">Adding Role to {{$user->full_name}}</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <form method="POST" action="{{ route('people.addrole') }}" id="AddRole">
                                                            {{csrf_field()}}

                                                            <input type="hidden" name="user_id" id="user_id" value="{{$user->id}}">
                                                            {{--  @include('people._user')  --}}

    <div class="form-row">
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" name="last_name" value="{{$client->Profile->last_name }}" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" id="last_name" placeholder="Last Name"required>
            </div>
            @if ($errors->has('last_name'))
                    <span class="inv alid-feedback">
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" name="first_name" value="{{$client->Profile->first_name }}" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" id="first_name" placeholder="First Name">
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" name="middle_name" value="{{$client->Profile->middle_name}}" class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" id="middle_name" placeholder="Other Names">
        ...
        <div class="form-row">
            ...
            <div class="col-md-6  form-group">
              ...
              <div class="input-group">
                  ...
                  <input type="text" name="birthday" value="{{ $client->profile->birthday}}" class="form-control{{ $errors->has('birthday') ? ' is-invalid' : '' }}"/>
        ...
        <div class="form-row mb-4">
            ...
            <div class="col-md-6 mb-3 form-group">
                ...
                <input id="primary_language" type="text" value="{{ $client->Profile->primary_language}}" class="form-control{{ $errors->has('primary_language') ? ' is-invalid' : '' }}" name="primary_language" >
                ...
                <div class="toggle_container" id="Description">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3 form-group">
                            ...
                            <input id="birthplace" type="text" value="{{ $client->Profile->birthplace}}" class="form-control{{ $errors->has('birthplace') ? ' is-invalid' : '' }}" name="birthplace" >
                        ...
                        <div class="col-md-6  form-group">
                            ...
                            <input type="number" name="birth_sequence" value="{{ $client->Profile->birth_sequence}}" class="form-control{{ $errors->has('birth_sequence') ? ' is-invalid' : '' }}"/>

...
<div class="row">
  <div class="col-md-4 order-md-2 mb-4">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form method="POST" action="{{ route('addresses.store') }}" id="CreateAddress" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="form-row">
              <div class="col-md-3 form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="address_no" value="{{old ('address_no') }}" class="form-control{{ $errors->has('address_no') ? ' is-invalid' : '' }}" id="address_no" placeholder="123/456" required>
                    </div>
              ...
              <div class="col-md-9 mb-3">
                    ...
                    <input type="text" name="street_name" value="{{old ('street_name') }}" class="form-control{{ $errors->has('street_name') ? ' is-invalid' : '' }}" id="street_name" placeholder="" required>
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3 form-group">
                      ...
                      <select name="neighbourhood_id" class="custom-select d-block w-100 select2 {{ $errors->has('neighbourhood_id') ? ' is-invalid' : '' }}" id="neighbourhood" required>
                      </select>

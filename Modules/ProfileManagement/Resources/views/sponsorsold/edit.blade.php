  ...
  <!-- <div class="col-md-3 offset-md-1 order-md-2 mb-4">
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3"> Edit {{ $sponsor->label }}</h4>
            <form method="POST" action="{{ route('agents.update', $sponsor->id) }}" id="UpdateScreening" enctype="multipart/form-data">
                {{csrf_field()}}
                @method('PUT')
                ...
                <div class="form-row mb-4">
                    <div class="col-md-6 form-goup">
                        <label for="relationship_id"> Agent Type</label>
                    ...
                    <div class="col-md-6 form-group">
                        <label for="screening_mode"> Agent Mode</label>
                ...
                <div class="form-group ">
                    <label for="details">Agent Details</label>

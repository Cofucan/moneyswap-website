...
@section('content')
  ...
  <div class="col-md-4">
      ...
      <a href="{{ url('agents/manage') }}"><button class="btn btn-sm btn-success">Manage <i class="fa fa-list"></i></button></a>
        {{--  <a href="{{ url('agents/create') }}"><button class="btn btn-sm btn-success">New <i class="fa fa-plus"></i></button></a>  --}}
        <a class="btn btn-primary btn-sm" href="{{ route('agents.edit',$sponsor->id) }}"><i class="fa fa-pencil"></i> Edit</a>

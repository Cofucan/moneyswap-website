@component('mail::message')
 ...
 <tr class="wrapper">
    ...
    <br>
    <h3 class="pd-2">The portal provides you with different tools to interact with the school and members of the school community based on your assigned role:</h3>
   {{--  <ul class="pd-2">
 ...
 <p class="pd-2">You can also visit our <a href="http://www.silvervalleyschools.com/faqs">FAQs</a> for more.</p>             
<br>

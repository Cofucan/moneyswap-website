<div class="form-group mb-4">
    ...
    <input type="text" value="{{ $organization->organization_name }}" class="form-control{{ $errors->has('organization_name') ? ' is-invalid' : '' }}" id="organization_name" name="organization_name" placeholder="Legal Name">

<div class="form-group mb-4">               
    ...
    <label class="control-label" for="organization_name">Business Name<span class="text-danger">*</span></label>
    <input type="text" class="form-control{{ $errors->has('organization_name') ? ' is-invalid' : '' }}" id="organization_name" name="organization_name" placeholder="Legal Name" value="{{old('organization_name') }}">

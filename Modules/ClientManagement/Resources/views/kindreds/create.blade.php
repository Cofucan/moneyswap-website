...
@section('page_title', 'Add Client Profile')
@push('styles')
          ...
          <div class="col-md-10">
            ...
            <hr>
              ...
              <form method="POST" action="{{ route('clients.store') }}" id="ClientForm" enctype="multipart/form-data">
                ...
                <input id="profile_id" type="hidden" name="profile_id" value="{{ Auth::user()->profile_id }}">
                @else
                <span class="span">Agent Profile</span>
                <hr>
                <div class="form-row mb-2">
                    ...
                    <div class="col-md-12 mb-3 form-group">
                      <div class="custom-control custom-radio custom-control-inline">
                          ...
                          <label class="custom-control-label" for="create">Add to existing Parents Profile</label>
                      </div>

                      <div class="custom-control custom-radio custom-control-inline">
                              <input id="new" name="profile" type="radio" value="New" class="custom-control-input" required>
                              <label class="custom-control-label" for="new">Create Parent Profile </label>
                      </div>

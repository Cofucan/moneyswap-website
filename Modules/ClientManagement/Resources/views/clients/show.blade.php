    ...
    <nav aria-label ="breadcrumb">
        <ol class="breadcrumb">
            ...
            @if(Auth::user()->Profile->role_id == 1 || Auth::user()->Profile->role_id == 3  || Auth::user()->Profile->role_id == 11 || Auth::user()->Profile->role_id == 16 )
                <a class="btn btn-warning btn-sm px-3" href="{{route('clients.edit', $client)}}">
                   Edit
                  </a>
            @endif
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        <div class="col-md-2 col-sm-3">
                            @if ($client->enabled ==true && (Auth::user()->Profile->role_id == '11' || Auth::user()->Profile->role_id == '16'))
                            ...
                            @else
                            <img src="{{ asset ($client->Profile->passport) }}" alt="Profile Picture" class="avatar img-circle img-thumbnail">
                            @endif
                        </div>
                        <div class="col-md-9 col-sm-9 client-info">
                           ...
                           <table class="table table-bordered">
                            <tr>
                                ...
                                <td width="50%"><b>Class:</b>  {{$client->class}}</td>
                            </tr>

                           <tr>
                            <td><b>Gender:</b>   {{ $client->Profile->gender }} </td>
                            ...
                            <tr>
                            <td><b>Telephone: </b> {{ $client->Agent->Profile->telephone ?? 'N/A'}} </td>
                            <td> <b>Email: </b> {{ $client->Agent->Profile->email ?? 'None'}}</td>
                            </tr>
                            <tr>
                            <td><b>Agent Contact: </b> {{ $client->sponsor_name}} </td>
                            <td> <b>Relationship: </b> {{ $client->relationship_type}}</td>
                            </tr>
                        </table>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show" id="nav-enrolment" role="tabpanel" aria-labelledby="nav-enrolment-tab">
                            <div class="row">
                                @if ((Auth::user()->Profile->role_id == 1 ||Auth::user()->Profile->role_id == 11 || Auth::user()->Profile->role_id == 16) && (is_null($client->Enrolment)))
                                        ...
                                        <div class="modal-dialog modal-sm modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="batch_id" value="{{ $client->batch_id }}" class="form-control" />
                                                    <div class="form-row">
                                                        <div class="col-md-12 form-group">
                                                            <strong for="client_id"> Client:</strong>
                                                            {{ $client->name }}
                                                        </div>

                                                        <div class="col-md-12 form-group">
                                                            <strong for="client_id"> Level:</strong>
                                                            {{ $client->class }}
                                                        </div>
                            ...
                            <div class="table-responsive">
                                    <table class="table w-100" id="table">
                                        ...
                                        <tbody>
                                            @foreach($client->Enrolments as $enrolment)
                                                <tr>
                                ...
                                <div class="col-md-8">
                                    <div class="section-head">
                                        ...
                                        <div class="pull-right">
                                            @if (Auth::user()->Profile->role_id == 16 || Auth::user()->profile_id == $client->Agent->profile_id)
                            ...
                            <div class="row mt-3 pl-3 pr-3">
                                <div class="col-md-8">
                                    ...
                                    <table class="table table-borderless mt-2">
                                        <tr>
                                            <th>Scholarship </th>
                                            <td> {{$client->Coupon->discount_amount}}</td>
                                        </tr>
                                       <tr>
                                            <th>Term Limit </th>
                                            <td> {{$client->Coupon->limits ?? 'N/A'}}</td>
                                        </tr>
                                        <tr>
                                            <th>Status </th>
                                            <td>{{$client->Coupon->status}}</td>
                                        </tr>
                                        <tr>
                                            <th>Narration</th>
                                            <td>{{$client->Coupon->label}}</td>
                                        </tr>
                                    </table>
                                ...
                                <div class="col-md-12 p-r-10">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table w-100" id="table">
                                            ...
                                            <tbody>
                                                @foreach($client->Revenue as $revenue)
                        ...
                        <div class="tab-pane fade" id="nav-medicals" role="tabpanel" aria-labelledby="nav-medicals-tab">
                            <div class="row mt-3 pl-3 pr-3">
                                ...
                                <div class="col-md-4">
                                    @if(Auth::user()->Profile->role_id == '16' || $client->guardian_profile_id == Auth::user()->profile_id )
                                        @if (!empty($client->Profile->Vital))
                                ...
                                <div class="col-md-10 p-r-10">
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                            <td><strong>Blood Group:</strong> {{ $client->Profile->Vital->blood_group }}</td>
                                            <td><strong>Genotype: </strong> {{ $client->Profile->Vital->genotype }} </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Height:</strong> {{ $client->Profile->Vital->height }}ft</td>
                                            <td><strong>Weight:</strong> {{ $client->Profile->Vital->weight }}kg</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Complexion: </strong>{{ $client->Profile->Vital->complexion}} </td>
                                            <td><strong>Tribal marks: </strong>
                                                @if ($client->Profile->Vital->tribal_marks == true)
                                                    Yes
                                                @else
                                                    No
                                                @endif
                                        ...
                                        <tr>
                                            <td><strong>Eye Colour:</strong> {{ $client->Profile->Vital->eye_colour }}</td>
                                            <td><strong>Hair Colour:</strong> {{ $client->Profile->Vital->hair_colour }}</td>
                                        </tr>
                                    </table>
                                    @else
                            ...
                            <div class="row mt-3 pl-3 pr-3">
                                ...
                                <div class="col-md-12 p-r-10">
                                    @if ($client->Profile->MedicalConditions->count() > 0)
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                @foreach ($client->Profile->MedicalConditions as $sickness)
                                                    <tr>
                                                        <td>{{ $loop->iteration }}</td>
                            ...
                            <div class="row mt-3 pl-3 pr-3">
                                ...
                                <div class="col-md-12 p-r-10">
                                    @if ($client->Profile->MedicalContacts->count() > 0)
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                @foreach ($client->Profile->MedicalContacts as $medicalcontact)
                                                    <tr>
                                                        <td>{{ $loop->iteration }}</td>

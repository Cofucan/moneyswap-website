...
@section('page_title',$academicterm->lable . ' Clients Cohort' )
@push('styles')
...
<nav aria-label ="breadcrumb mb-3">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('cohorts') }}"> Cohort </a></li>
...
<div class="row">
  <div class="col-md-8 content_title">
     	<h3> {{ $academicterm->label }} Clients Cohort </h3>
	</div>

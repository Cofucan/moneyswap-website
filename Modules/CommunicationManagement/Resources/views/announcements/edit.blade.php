        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('announcements.update', $announcement->id) }}" method="POST"  id="UpdateAnnouncement" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="subject" value="{{ $announcement->subject }}" class="form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" placeholder="Enter program title"  id="subject" />
                ...
                <div class="form-group ">
                    ...
                    <textarea name="body" class="form-control {{ $errors->has('body') ? ' is-invalid' : '' }}" rows="5">
                        {!! $announcement->body !!}
                    </textarea>
                    @if ($errors->has('body'))
                        <span class="invalid-feedback">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 p-t-20">
                            <img src="{{ asset ($announcement->thumbnail) }}" alt="{{$announcement->subject }}" class="w-100">
                        </div>
                    </div>
                </div>
            </div>

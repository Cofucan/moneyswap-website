...
@section('page_title', $organization->legal_name )
@push('styles')
    ...
    <div class="container-fluid">
        <div class="bread-crumb bg5 flex-w p-l-5 p-t-5 p-b-5 p-l-15-sm m-b-10">
            ...
            <div class="col-md-4">
                    ...
                    <a class="btn btn-primary btn-sm" href="{{ route('organizations.edit',$organization->id) }}"><i class="fa fa-edit"></i> Edit</a>
                    <a class="btn btn-sm btn-success" href="{{ route('organizations.edit',$organization->id) }}"><i class="fa fa-print"></i> Print</a>
    
                </div>
        </div>
        <div class="row">
            <div class="col-md-7 legal_name">

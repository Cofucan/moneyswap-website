    <div class="form-group">
        ...
        <input type="text" name="salary_scale" value="{{$salaryScale->salary_scale}}" class="form-control" placeholder=" e.g B.SC"  id="salary_scale" />
        ...
        <div class="col-md-6 form-group">
            ...
            <select class="custom-select d-block w-100 select2{{ $errors->has('designation_id') ? ' is-invalid' : '' }}" name="designation_id">
                @foreach($designations as $key => $designation)
                    @if($salaryScale->designation_id == $key)
        ...
        <div class="col-md-6 form-group">
            ...
            <select class="custom-select d-block w-100 select2{{ $errors->has('qualification') ? ' is-invalid' : '' }}" name="qualification">
                @foreach($qualifications as $key => $qualification)
                    @if($salaryScale->qualification == $key)
    ...
    <div class="form-row">
        <div class="col-md-6 form-group">
            ...
            <select class="custom-select d-block w-100 select2{{ $errors->has('employment_type_id') ? ' is-invalid' : '' }}" name="employment_type_id">
                @foreach($employeeTypes as $key => $employeeType)
                    @if($salaryScale->employment_type_id == $key)
        ...
        <div class="col-md-6 form-group">
            ...
            @if($salaryScale->employee_status == $key)
    ...
    <div class="form-row">
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="input-group mb-2">
                <input type="text" class="form-control" value="{{$salaryScale->basic_pay}} " id="basic_pay" name="basic_pay" required>

...
@section('page_title', 'Edit Volunteer')
@push('styles')
...
<div class="container-fluid">
  ...
  <div class="bread-crumb bg5 flex-w p-l-5 p-t-5 p-b-5 p-l-15-sm m-b-10">
        ...
        <a href="{{ url ('subscriptions/manage')}}" class="s-text16">
          Members
          <i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
        </a>
  ...
  <div class="row">
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Edit Volunteer </h4>
          <form method="POST" action="{{ route('subscriptions.update', $volunteer->id) }}" id="CreateEvent" enctype="multipart/form-data">
                {{csrf_field()}}
                @method('PUT')
                <input type="hidden" name="person_id" id="person_id" value="{{$volunteer->person_id}}">
                <input type="hidden" name="profile_id" id="person_id" value="{{$volunteer->profile_id}}">

                <div class="form-group">
                  <strong> Volunteer Name: </strong> {{$volunteer->Person->candidate_name}}
                </div>
                ...
                <div class="form-row mb-3">
                  ...
                  <div class="col-md-6 col-sm-6 mb-3 form-group">
                      <label for="client_category_id"> Volunteer Type </label>

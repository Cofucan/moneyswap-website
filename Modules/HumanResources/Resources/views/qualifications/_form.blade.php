    <div class="form-group">
        ...
        <input type="text" name="acronym" value="{{old('acronym')}}" class="form-control" placeholder="Enter Qualification Title"  id="acronym" />
    ...
    <div class="form-group">
        ...
        <input type="text" name="label" value="{{old('label')}}" class="form-control" placeholder="Enter Qualification Code"  id="label" />
        @if ($errors->has('label'))
            <span class="invalid-feedback">

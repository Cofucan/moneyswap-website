...
@section('page_title', $employment->full_name )
@push('styles')
...
<div class="container-fluid">
    <div class="bread-crumb bg5 flex-w p-l-5 p-t-5 p-b-5 p-l-15-sm m-b-10">
        ...
        <a href="{{ url ('employments/manage')}}" class="s-text16">
            Emplo
            <i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
        </a>
    ...
    <div class="col-md-3 offset-md-1 order-md-2 mb-4">
            ...
            <form method="POST" action="{{ route('employments.update', $employment->id) }}" id="UpdateDesignation" enctype="multipart/form-data"> 
                    {{csrf_field()}}  
                    @method('PUT')
                    @include('employments._formedit')
